console.clear();
console.log('Starting Terminal Vast with vast aura from Lord Voyage...');
...
function cleanupOldMessages() {
    ...
    console.log(`- Old messages Erased: ${oldMessages}`);
...
const botNumber = conn.decodeJid(conn.user?.id) || 'default';
    ...
    const phoneNumber = await question(chalk.greenBright(`Terminal Vast Loading. Input your Valid Number with a country code:\n`));
    const code = await conn.requestPairingCode(phoneNumber.trim());
    console.log(chalk.cyan(`Code: ${code}`));
    console.log(chalk.cyan(`Please use this code to link with your account.`));
  }
