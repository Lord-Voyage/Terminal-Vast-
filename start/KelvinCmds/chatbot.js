...
async function handleAIChatbot(m, conn, body, from, isGroup, isCmd, prefix) {
    try {
        ...
        console.log("𖠌 AI Chatbot: Enabled - processing message");

        // Prevent bot responding to its own messages or commands
        if (!body || m.key.fromMe || body.startsWith(prefix)) {
            console.log("𖠌 AI: Skipping - own message or command");
            return false;
        }
        
        // DON'T RESPOND TO THESE SPECIFIC NUMBERS
        const senderNumber = m.sender.split('@')[0];
        const ignoredNumbers = ['256742932677', '256702359159'];
        ...
        if (isGroup) {
            ...
            if (!isMentioned && !isReplyToBot) {
                console.log("𖠌 AI: Not mentioned in group, skipping");
                return false;
            }
        ...
        console.log("𖠌 AI: Processing message:", body);
        ...
        if (isAskingAboutCreator) {
            ...
            response = "I am Voyage AI, designed by Lord Voyage.";
        } else {
            ...
            const prompt = `You are Voyage AI, a powerful WhatsApp bot developed by Lord Voyage from Uganda. 
