...
async function githubCommand(conn, chatId, message) {
  try {
    // Use your GitHub repository
      const res = await fetch('https://api.github.com/repos/Lord-Voyage/LordVoyageCyberRealm');
...
`;
    ...
    try {
        await conn.sendMessage(
            chatId,
            {
                image: { url: 'https://files.catbox.moe/g1x77n.jpg' }, // Your bot image
                caption: txt
            },
            { quoted: message }
        );
    ...
    await conn.sendMessage(
        chatId, 
        { 
            text: '❌ Error fetching repository information.\n\n🔗 Manual link: https://github.com/Lord-Voyage/LordVoyageCyberRealm' 
        }, 
        { quoted: message }
    );
  }
